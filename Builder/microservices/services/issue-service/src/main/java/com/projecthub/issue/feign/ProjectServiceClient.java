package com.projecthub.issue.feign;

import com.projecthub.common.api.result.Result;
import com.projecthub.issue.feign.dto.ProjectInfoDTO;
...
public interface ProjectServiceClient {
     ...
     */
    @PostMapping("/batch")
    Result<List<ProjectInfoDTO>> getProjectsByIds(@RequestBody List<Long> ids);
